...
if __name__ == '__main__':
    ...
    print('Output', output.shape, tf.math.reduce_max(output), tf.math.reduce_min(output))
    print('Output', target.shape, tf.math.reduce_max(target), tf.math.reduce_min(target))
